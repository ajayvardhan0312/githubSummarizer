# githubSummarizer
Github Summarizer is a Chrome extension developed using Flask-powered backend that automatically summarizes any public GitHub repository using OpenAI’s GPT models.
